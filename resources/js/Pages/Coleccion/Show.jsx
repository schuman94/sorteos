    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto p-6 space-y-8">
                ...
                <div className="grid sm:grid-cols-2 gap-6 bg-white border rounded-lg p-4 shadow-sm">
                    <div>
                        <h2 className="text-sm font-semibold text-gray-600">Descripción</h2>
                        <p className="text-gray-800">{coleccion.descripcion}</p>
                    </div>
                    <div>
                        <h2 className="text-sm font-semibold text-gray-600">Fecha de creación</h2>
                ...
                {/* Botón ver rascas proporcionados */}
                ...
                {/* Formulario para obtener rascas */}
